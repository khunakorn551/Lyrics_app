        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <p class="mb-4">Your privacy is important to us. This privacy policy explains how we collect, use, disclose, and safeguard your information when you visit our website https://www.karensonglyrics.com, including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the "Site"). Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the Site.</p>
                    ...
                    <ul class="list-disc list-inside mb-4">
                        <li>Personal Data: Information you provide when you register for an account, such as your name and email address, or when you submit comments or contact us through the website.</li>
                        <li>Usage Data: Information our servers automatically collect when you access the Site, such as your IP address, browser type, operating system, access times, and the pages you visit.</li>
                    </ul>

                    <h3 class="text-lg font-semibold mb-4">Use of Your Information</h3>
                    ...
                    <ul class="list-disc list-inside mb-4">
                        ...
                        <li>Allow you to comment on lyrics and participate in community features.</li>
                        <li>Respond to your inquiries and provide customer support.</li>
                        <li>Improve our website and user experience through analytics and feedback.</li>
                    </ul>

                    <h3 class="text-lg font-semibold mb-4">Disclosure of Your Information</h3>
                    ...
                    <h3 class="text-lg font-semibold mb-4">Security of Your Information</h3>
                    <p class="mb-4">We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.</p>

                    <h3 class="text-lg font-semibold mb-4">Contact Us</h3>
                    <p>If you have questions or comments about this Privacy Policy, please contact us at <a href="mailto:jan842070@gmail.com">jan842070@gmail.com</a>.</p>
                </div>
            </div>
        </div>
    </div>
